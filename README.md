...
6. Join the server and make sure everything works
7. type `whitelist off` to release the server.

Credit to Gurusekar for making all skripts.
These skripts may NOT be resold or shared/claimed as your own work.

Credits to HaydenRedHair for making the map.
